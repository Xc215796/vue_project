<template>
  <div class="app-container">
    ...
    <!-- <div style="display:flex;margin-bottom:10px">
      <el-button size="small" type="primary" style="margin-right:10px;height:40px" @click="toAdd()">新增</el-button>
      <el-input v-model="input" placeholder="请输入状态" style="width:200px;margin-right:10px"></el-input>
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="30%"  :before-close="close">
      ...
      <el-form label-width="80px">
        ...
        <el-form-item label="状态" v-if='waiter_info.status=="启用"'>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <!-- 抽屉 -->
    <el-drawer title="员工详情" :visible.sync="drawer" :before-close="cancelForm">
      <div class="demo-drawer__content">
        <el-form :model="form">
          <el-form-item label="姓名" :label-width="formLabelWidth">
            <el-input v-model="waiter_info.id" placeholder="请输入内容" readonly="readonly"></el-input>
          </el-form-item>
          <el-form-item label="手机号" :label-width="formLabelWidth">
            <el-input v-model="waiter_info.telephone" placeholder="请输入内容" readonly="readonly"></el-input>
          </el-form-item>
          <el-form-item label="状态" :label-width="formLabelWidth">
            <el-input v-model="waiter_info.status" placeholder="请输入内容" readonly="readonly"></el-input>
          </el-form-item>
          <el-form-item label="头像" :label-width="formLabelWidth">
            <template>
              <img :src="waiter_info.imgPhoto" alt width="100px" height="100px" />
            </template>
          </el-form-item>
        </el-form>
      </div>
